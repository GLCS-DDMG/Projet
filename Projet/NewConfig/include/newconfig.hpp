...
#define DEFAULT_POST_PROCESSING 0
#endif
...
public:
	...
	// see overridden function
	int get_post_processing_state() const override { return m_post_processing; }
