...
void HDF5write::simulation_updated_post_processing(const Distributed2DField& data)
{
	// Getting Block height and width
	hsize_t block_height = 1;
	hsize_t block_width = 1;

	// Getting average to write
	PostProcessing avg_data(data);

	// File name 
	string file_name = "./ResultHDF5/my_file_pp_" + to_string(data.time()) + ".h5";
